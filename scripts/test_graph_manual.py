"""Manual test script for the deep research graph."""
...
async def test_proactive_intake():
    """Test the proactive research intake flow with a broad topic."""
    print("Testing Proactive Research Intake Flow...")

    # Starting with a broad topic, let's see if the agent infers and suggests
    initial_state = {
        "messages": [
            HumanMessage(content="I want to research current AI energy use in the US.")
        ],
        "supervisor_messages": [],
        "active_tasks": [],
    }
