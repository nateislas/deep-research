...
- [Computational Biology Report](docs/example_output/final_report_1.md): "I want to learn about the new AI models that are being used in AI+computational biology. Specifically what models are being used with raw sequence (DNA/RNA/proteins/etc). How have this changed over the past 6 years."
- [Spatial Reasoning Report](docs/example_output/final_report_2.md): "Can world models reason over spatial data?"
